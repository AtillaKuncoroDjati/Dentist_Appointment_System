<section id="contact" class="contact">
    <div class="container">
        ...
        <div class="section-title">
            <h2>Contact</h2>
            <p>Jika Anda memiliki pertanyaan spesifik tentang kami maupun layanan kami, jangan ragu untuk menghubungi
                Kanna Dentist. Kami akan dengan senang hati menjawab pertanyaan Anda.</p>
        </div>
    ...
    <div class="container">
        ...
        <div class="row mt-5">
            ...
            <div class="col-lg-6">
                <form id="messageForm" action="{{ route('contact.store') }}" method="POST" role="form"
...
<script src="{{  asset('assets/js/user/contact.js')  }}"></script>
